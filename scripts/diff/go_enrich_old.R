...
ggplot(res_sig2, aes(x= Description, y = Count, fill = -log10(p.adjust))) + geom_col(colour="#666666") +
...
ggsave(snakemake@output[["barplot"]][1], width = 20, height = 10)
ggsave(snakemake@output[["barplot"]][2], width = 20, height = 10)
...
ggsave(snakemake@output[["dotplot"]][1], width = 20, height = 10)
ggsave(snakemake@output[["dotplot"]][2], width = 20, height = 10)
